...
<head>
	...
	<script src="<c:url value="/resources/jslibrary/angular.min.js" />"></script>
	...
	<script src="<c:url value="/resources/js/angular_script.js" />"></script>
    <%-- <script src="<c:url value="/resources/js/jquery.1.10.2.min.js" />"></script>
    <script src="<c:url value="/resources/js/main.js" />"></script> --%>
</head>
<body ng-app="mainPageApp"  ng-controller="loginCtrl">
	...
	<div class="login-form sign-up-form">
	    <form class="add-box-shadow" action="/examples/actions/confirmation.php" method="post">
	        ...
	        <div class="form-group">
	             ...
	             <input type="text" class="form-control" ng-model="firstname" name="firstName" data-custom-input="input" placeholder="First name" required="required">		
	        </div>
			<div class="form-group">
